 ...
 */
final class Version20190210103349 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE post (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, text CLOB NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, title VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__post AS SELECT id, text, created_at, updated_at, title FROM post');
        $this->addSql('DROP TABLE post');
        $this->addSql('CREATE TABLE post (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, text CLOB NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, author_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO post (id, text, created_at, updated_at, title) SELECT id, text, created_at, updated_at, title FROM __temp__post');
        $this->addSql('DROP TABLE __temp__post');
